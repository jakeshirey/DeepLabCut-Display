...
This tool is meant to compliment the output of a DeepLabCut and allow a video with landmark annotations to be displayed with a plot of the coordinates of the landmark points. 
